...
public class AirportTest {
    ...
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified() {
        ...
        List<ExperimentalPlane> experimentalPlanesWithoutClassification = airport.getExperimentalPlanesWithoutClassification();
        Assert.assertNotEquals(experimentalPlanes, experimentalPlanesWithoutClassification);
    }
}
